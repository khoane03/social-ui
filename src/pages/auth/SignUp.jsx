...
export const SignUpPage = () => {
  ...
  const renderStepContent = () => {
    switch (currentStep) {
      case 0:
        return <RegisterAccount onSubmit={handleRegisterAccount} />;
      case 1:
        return <RegisterUser onSubmit={handleRegisterUser} />;
      default:
        return <IntroLoading />;
    }
  };
  ...
  return (
    <div className="flex flex-col md:flex-row gap-4 md:rounded-4xl w-full h-full overflow-hidden select-none">
      ...
      <motion.div
        ...
        className="flex-5 md:flex-7 flex flex-col items-center justify-center bg-[#7F9FEF] rounded-t-[25%] md:rounded-r-4xl md:rounded-l-[35%]"
      >
        <motion.h1
        ...
        >
          <Link
            to="/auth"
            className="inline-block p-2 border rounded-2xl mt-2 hover:scale-105 transition-transform duration-300"
          >
            Đăng nhập
          </Link>
        </motion.div>
